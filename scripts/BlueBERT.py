...
pretrained_csv = os.path.join(OUTPUT_DIR, "pretrained_extracted_entities_bluebert.csv")
...
pd.DataFrame(fine_tuned_results).to_csv(os.path.join(OUTPUT_DIR, "fine_tuned_extracted_entities_bluebert.csv"), index=False)
