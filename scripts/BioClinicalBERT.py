...
fine_tuned_extracted_csv = os.path.join(OUTPUT_DIR, "filtered_extracted_entities_with_bioclinicalbert.csv")
preprocessed_df.to_csv(fine_tuned_extracted_csv, index=False)
print(f"Fine-tuned extracted entities saved to {fine_tuned_extracted_entities.csv}")
